...
//    INIT_SYMCOLOR(0xFF, 0xEB, 0xCD, "BlanchedAlmond"),           // 
    ...
    INIT_SYMCOLOR(0xA5, 0x2A, 0x2A, "Brown"),                    // x
    INIT_SYMCOLOR(0xDE, 0xB8, 0x87, "BurlyWood"),                // x
    INIT_SYMCOLOR(0x8B, 0x45, 0x13, "SaddleBrown"),              // x
    INIT_SYMCOLOR(0xFA, 0x80, 0x72, "Salmon"),                   // x
    INIT_SYMCOLOR(0xF4, 0xA4, 0x60, "SandyBrown"),               // x
    INIT_SYMCOLOR(0x5F, 0x9E, 0xA0, "CadetBlue")                 // x
};
#elif defined(LIGHT_COLORS)
static ColorDefinition g_ColorDefinitions[] =
{
    INIT_SYMCOLOR(0xDE, 0xB8, 0x87, "BurlyWood"),                       // 
    INIT_SYMCOLOR(0x5F, 0x9E, 0xA0, "CadetBlue"),                       // x
    INIT_SYMCOLOR(0x7F, 0xFF, 0x00, "Chartreuse"),                      // x
    INIT_SYMCOLOR(0xD2, 0x69, 0x1E, "Chocolate"),                       // x
...
static ColorDefinition g_ColorDefinitions[] =
{
    ...
    INIT_SYMCOLOR(0x00, 0x00, 0x00, "Black"),                           // 
    INIT_SYMCOLOR(0xFF, 0xEB, 0xCD, "BlanchedAlmond"),                  // 
    INIT_SYMCOLOR(0x00, 0x00, 0xFF, "Blue"),                            // d 
    INIT_SYMCOLOR(0x8A, 0x2B, 0xE2, "BlueViolet"),                      // d
    INIT_SYMCOLOR(0xA5, 0x2A, 0x2A, "Brown"),                           // d
    INIT_SYMCOLOR(0xDE, 0xB8, 0x87, "BurlyWood"),                       // 
    INIT_SYMCOLOR(0x5F, 0x9E, 0xA0, "CadetBlue"),                       // x
    INIT_SYMCOLOR(0x7F, 0xFF, 0x00, "Chartreuse"),                      // x
    INIT_SYMCOLOR(0xD2, 0x69, 0x1E, "Chocolate"),                       // x
    INIT_SYMCOLOR(0xFF, 0x7F, 0x50, "Coral"),                           // x
    ...
    INIT_SYMCOLOR(0x00, 0x8B, 0x8B, "DarkCyan"),                        // x
    INIT_SYMCOLOR(0xB8, 0x86, 0x0B, "DarkGoldenRod"),                   // x
    INIT_SYMCOLOR(0xA9, 0xA9, 0xA9, "DarkGray"),                        // 
...
static _str _getAnotherColor(int &colorIndex, int offset)
{
    ...
    do
    {
        ...
        {
            colorIndex -= g_ColorDefinitions._length();
        }
        if (colorIndex < 0)
        {
            colorIndex += g_ColorDefinitions._length();
